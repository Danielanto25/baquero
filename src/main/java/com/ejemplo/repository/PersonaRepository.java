...
public class PersonaRepository {
	...
	public void update(Persona persona) {
		...
		String sql = "update persona set per_nombre=:nombre,per_apellido=:apellido,per_identificacion=:identificacion,"
				...
				+ "update usuario set usu_estado=:estado,usu_cliente=:cliente,usu_ip=:ip,usu_usu_usuario=:usuario where per_codigo=:codigo;"
				+ "update estudiante set est_estado=:estado,est_cliente=:cliente,est_ip=:ip,est_usuario=:usuario where per_codigo=:codigo ";
